...
//   }
  ...
  try {
    let result = await db.executeQuery(`EXEC FetchRequests 
      @grade,@customerIdsArray,
      @consigneeIdsArray,@plantIdsArray,
      @endUseId,@SymmetricKeyName,@CertificateName `,
      {
        grade: grade,
        customerIdsArray: customerIdsArray,
        consigneeIdsArray: consigneeIdsArray,
        plantIdsArray: plantIdsArray,
        endUseId: endUseId,
